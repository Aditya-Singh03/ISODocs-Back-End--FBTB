...
@Repository
public interface DocumentCustomRepository extends JpaRepository<DocumentComplete, Long> {
    ...
    public List<DocumentComplete> findByName(@Param("attachment_id") String attachment_id, @Param("file_name") String file_name, @Param("project_name") String project_name, @Param("customer_name") String customer_name, @Param("commitment_period_id") String commitment_period_id, @Param("resource_name") String resource_name);
}