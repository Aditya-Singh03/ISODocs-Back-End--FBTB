...
public class DocumentDetailController {
    ...
    public documentDetailReturn documentDetail(@RequestParam Long attachment_id) {
        ...
        ArrayList<Map<String, Object>> info = attachmentFileService.queryForDocumentsOptional(attachment_id, null, null, null, null, null);
        ...
        metaReturn metaData = documentDetailService.meta(map.get("file_name").toString(), map.get("projectName").toString(), map.get("projectType").toString(), map.get("beginDate").toString(), map.get("endDate").toString(), map.get("periodType").toString(), map.get("custName").toString(), map.get("resourceName").toString(), map.get("resourceType").toString(), map.get("aucType").toString(), map.get("proposalLabel").toString(), map.get("attachmentType").toString(), 0);
